...
VALUES 
('aa2fd051-4f38-4987-857c-51d3ba650cea', 'Fórmula de Bhaskara', 'Revise equações de 2º grau para garantir pontos em Matemática básica. A fórmula é essencial para o ENEM!', 0, 1, 'lightbulb-on', '#ffffff', NULL, NULL, NULL, true, 1, NULL, NULL, NULL, '{}', gen_random_uuid()::text, NOW(), NULL, NULL, NULL, false, NULL, NULL),
('bb2fd051-4f38-4987-857c-51d3ba650cca', 'Edital FUVEST 2024', 'Confira as principais mudanças no formato da prova e datas de inscrição. Não perca o prazo!', 1, 0, 'newspaper-variant-outline', '#3b82f6', 'rgba(59, 130, 246, 0.1)', NULL, NULL, true, 2, NULL, NULL, NULL, '{}', gen_random_uuid()::text, NOW(), NULL, NULL, NULL, false, NULL, NULL),
...
('ee2fd051-4f38-4987-857c-51d3ba650cea', 'Como tirar 1000 na Redação', 'Aprenda as 5 competências avaliadas e técnicas para desenvolver sua argumentação de forma impecável.', 2, 0, 'pen', '#ec4899', 'rgba(236, 72, 153, 0.1)', NULL, NULL, true, 5, NULL, NULL, NULL, '{}', gen_random_uuid()::text, NOW(), NULL, NULL, NULL, false, NULL, NULL);
