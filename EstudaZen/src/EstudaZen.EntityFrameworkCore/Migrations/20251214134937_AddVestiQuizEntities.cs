...
{
    /// <inheritdoc />
    public partial class AddVestiQuizEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxSchools = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSimulados", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnemAreaCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPaymentAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppSubscriptions_AppPlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuizQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppQuizQuestions_AppQuizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnemScoreLinguagens = table.Column<int>(type: "integer", nullable: true),
                    EnemScoreMatematica = table.Column<int>(type: "integer", nullable: true),
                    EnemScoreCienciasHumanas = table.Column<int>(type: "integer", nullable: true),
                    EnemScoreCienciasNatureza = table.Column<int>(type: "integer", nullable: true),
                    EnemScoreRedacao = table.Column<int>(type: "integer", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSimuladoQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSimuladoQuestions_AppSimulados_SimuladoId",
                        column: x => x.SimuladoId,
                        principalTable: "AppSimulados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppQuestions_TenantId_SubjectId_Difficulty",
                table: "AppQuestions",
                columns: new[] { "TenantId", "SubjectId", "Difficulty" });

            migrationBuilder.CreateIndex(
                name: "IX_AppQuizQuestions_QuizId",
                table: "AppQuizQuestions",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_AppQuizzes_StudentId_Status",
                table: "AppQuizzes",
                columns: new[] { "StudentId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AppSchools_TenantId_Name",
                table: "AppSchools",
                columns: new[] { "TenantId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_AppSimuladoQuestions_SimuladoId",
                table: "AppSimuladoQuestions",
                column: "SimuladoId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSimulados_TenantId_IsPublished",
                table: "AppSimulados",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppStudents_TenantId_TotalXp",
                table: "AppStudents",
                columns: new[] { "TenantId", "TotalXp" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "IX_AppStudents_UserId",
                table: "AppStudents",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSubscriptions_PlanId",
                table: "AppSubscriptions",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSubscriptions_TenantId_Status",
                table: "AppSubscriptions",
