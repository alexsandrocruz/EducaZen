...
namespace EstudaZen.Migrations
{
    ...
    [Migration("20251219022803_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstudaZen.Achievements.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("GradientColors")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("EstudaZen.Achievements.StudentAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppStudentAchievements", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Classes.Class", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolYear", "IsActive");

                    b.ToTable("AppClasses", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Exams.Exam", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Exams.ExamAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Exams.ExamQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Exams.ExamSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentId", "ExamId", "Status");

                    b.ToTable("AppExamSessions", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentId", "IsRead", "CreationTime");

                    b.ToTable("AppNotifications", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Questions.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "SubjectId", "Difficulty");

                    b.ToTable("AppQuestions", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Questions.QuestionAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Quizzes.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppQuizzes", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Quizzes.QuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppQuizQuestions", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Schools.School", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Simulados.Simulado", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSimulados", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Simulados.SimuladoQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSimuladoQuestions", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("EnemScoreCienciasHumanas")
                        .HasColumnType("integer");

                    b.Property<int?>("EnemScoreCienciasNatureza")
                        .HasColumnType("integer");

                    b.Property<int?>("EnemScoreLinguagens")
                        .HasColumnType("integer");

                    b.Property<int?>("EnemScoreMatematica")
                        .HasColumnType("integer");

                    b.Property<int?>("EnemScoreRedacao")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "TotalXp")
                        .IsDescending(false, true);

                    b.ToTable("AppStudents", (string)null);
                });

            modelBuilder.Entity("EstudaZen.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EnemAreaCode")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
            ...
            modelBuilder.Entity("EstudaZen.Subscriptions.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Subscriptions.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Tips.Tip", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EstudaZen.Achievements.StudentAchievement", b =>
                {
                    b.HasOne("EstudaZen.Achievements.Achievement", "Achievement")
                        .WithMany()
                        .HasForeignKey("AchievementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EstudaZen.Students.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("EstudaZen.Exams.ExamAnswer", b =>
                {
                    b.HasOne("EstudaZen.Exams.ExamSession", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("EstudaZen.Exams.ExamQuestion", b =>
                {
                    b.HasOne("EstudaZen.Exams.Exam", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EstudaZen.Questions.Question", b =>
                {
                    b.HasOne("EstudaZen.Subjects.Subject", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("EstudaZen.Questions.QuestionAnswer", b =>
                {
                    b.HasOne("EstudaZen.Questions.Question", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("EstudaZen.Quizzes.QuizQuestion", b =>
                {
                    b.HasOne("EstudaZen.Quizzes.Quiz", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EstudaZen.Simulados.SimuladoQuestion", b =>
                {
                    b.HasOne("EstudaZen.Simulados.Simulado", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EstudaZen.Students.Student", b =>
                {
                    b.HasOne("EstudaZen.Schools.School", "School")
                        .WithMany()
            ...
            modelBuilder.Entity("EstudaZen.Subscriptions.Subscription", b =>
                {
                    b.HasOne("EstudaZen.Subscriptions.Plan", "Plan")
                        .WithMany()
